...
export default async function ActivitiesPage({
  ...
  searchParams: Promise<{ from?: string; to?: string; sort?: string; order?: string; page?: string }>;
}) {
  ...
  const validSortFields = ["startTime", "totalDistance", "totalMovingTime", "avgHeartRate", "efficiencyScore"];
